...
A shortage of content would raise ethical concerns and further complicate the already chaotic discussions held in parliament regarding this topic.
Delaying the decision is also highly unfavorable, because the government should stop losing money as early as possible.
As a result, the rather small reduction in Yle's funding successfully alleviates the issue of overallocation, but fails to offer a conclusive solution.
\newpage
...
Since the quantity of content consumed $Q_m$ is unaffected by this change, and the price is still zero, the consumers are entirely unaffected by this change.
