...
Consensus is reached after much deliberation, and consequently the budget of Yle will be cut by a noticeable but nonetheless timid amount.
This will be done by examining the situation through concepts such as government subsidies and market failure.
The funding for Yle is treated as a subsidy whose task is to correct market failure which arises from positive consumption externalities of news making the consumers more aware.
...
Figure 1 displays the effects of the new legislation with reference to the supply of content produced by Yle.
The curves $S_0$ and $S_1$ represent the supply before and after the budget is cut by the amount $d \approx 47$ million €. 
Consequently, the amount of content that is produced by Yle is reduced from $Q_0$ to $Q_1$.
