  ...
  \begin{center}
    \begin{tikzpicture}[scale=0.7]
      \begin{axis}[
          ...
          ytick={0,0.8,...,10},
          yticklabels={\empty},
          extra y ticks={0,1.6,...,10},
          extra y tick labels = {0,20,...,120},
          xmin = 0, xmax = 10,
          ymin = 0, ymax = 10,
          clip = false
        ]
        
        \addplot[domain = 0:10, restrict y to domain = 0:10, samples = 1000] {(285.01-x^2.72)^0.37};
        \addplot[domain = 0:10, restrict y to domain = 0:10, samples = 1000] {(285.01-x^2.72)^0.37};
...
hello.
\footnote{Source: \url{https://yle.fi/aihe/ylen-vuosi-2023}}
