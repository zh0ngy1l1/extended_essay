...
\begin{titlepage}
  \begin{center}
    ...
    What gives rise to the patterns and bounds in the graph of $f(n)=\varphi(n) \cdot \sigma(x)$, and how does this relate to the Riemann zeta function and the Basel problem?\\
...
This paper aims to investigate patterns in the graph of $f(n)=\varphi(n)\cdot\sigma(n)$.

\subsection{What are the functions}

$\varphi(n)$ is the "number of positive integers $\le n$ and coprime to $n$."
...
\begin{center}
  ...
  \begin{minipage}{0.55\textwidth} % Increase image width
    \centering
    \includegraphics[width=\textwidth]{1_phigma.png} % Make image take full width of minipage
  \end{minipage}
\end{center}

There are nice patterns in this graph, and we will explore them more closely.
