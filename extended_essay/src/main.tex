...
Since each term $\frac{p_i^2-1}{p_i^{\alpha_i+1}}$ is less than one, the more
terms we have, the smaller $f$ is.
But what gives more terms?
Each prime divisor of $n$ corresponds to a term in the product that gives $f(n)$.
