...
To approach \textbf{Problem 1}, we must improve our undrstanding on the functions $\sigma$ and $\varphi$. 
...
\vspace{1em}\begin{lemma}
  ...
  has a product which is an unique element in $\mathcal{D}_{mn}$.
\end{lemma}
\vspace{1em}
\begin{example}
  Let $m=9,\ n=14$.
