...
I'll write this later, when most other things are decided.
...
\end{align*}
A proof of these statements is presented in the \hyperref[sec:appendix]{appendix}, which the author recommends reviewing.
