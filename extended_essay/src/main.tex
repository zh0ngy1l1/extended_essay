...
\begin{titlepage}
  \begin{center}
    ...
    What gives rise to the patterns and bounds in the graph of $f(n)=\varphi(n) \cdot \sigma(x)$, and how does this relate to the Riemann zeta function?\\
...
\pagestyle{fancy}
\fancyfoot[L]{What gives rise to the patterns and bounds in the graph of $f(n)=\varphi(n) \cdot \sigma(x)$, and how does this relate to the Riemann zeta function?}
\fancyhead[L]{\thepage}
...
Initial guesses: AM, weighted AM, GM. 
